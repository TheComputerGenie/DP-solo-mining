...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddress) {
    ...
    //if (!process.env.forkId || process.env.forkId === '0') { logging('Blocks', 'error', 'Current block diff is: ' + this.difficulty) } //remove comment if you want to see diff changes per block
